      ...
      <div class="container-fluid page-body-wrapper">
        <!-- partial:partials/_sidebar.html -->
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="index.php?username123=">
            ...
            <li class="nav-item">
              <a class="nav-link" href="tables.php?username123=">
...
?>
                ...
                <li class="nav-item">
              <a class="nav-link" href="settings.php?username123=">
             ...
             <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="POST">
                      <div class="form-group">
                        <label for="exampleInputUsername1">Year Start</label>
                        <select type="date" class="form-control" name="date1" placeholder="ex. Juan dela Cruz">
                        ...
                        <div class="form-group">
                        <label for="exampleInputUsername1">Year End</label>
                        <select type="date" class="form-control" name="date2" placeholder="ex. Juan dela Cruz">
 ...
 if (!$con) {
    ...
    echo "Problem in database connection! Contact administrator!" . mysqli_error();
      ...
      $date1=$_POST['date1'];
         ...
         $sql ="SELECT Distinct result FROM data where date(date_added)>='$date1' and date(date_added)<='$date2' and result='$type' and device='$dev'";
                  ...
                  <div class="card-body">
                    ...
                    <table class="table ">
                      ...
                      <tbody>
                          ...
                          $date1=$_POST['date1'];
                                   $date2=$_POST['date2'];
                          	$query21a1=mysqli_query($con,"select * from  data  where date(date_added)>='$date1' and date(date_added)<='$date2' and result='$type' order by id desc ")or die(mysqli_error());
