...
$date=date("Y-m-d H:i");
		  ...
		  mysqli_query($con,"INSERT INTO chamber(code,name,hole) VALUES('$age','$title','$titl2e')")or die(mysqli_error($con));
		  
		  
		  if($titl2e>=1){
		      
		  mysqli_query($con,"INSERT INTO hole(code,plants,hole) VALUES('$age','0','1')")or die(mysqli_error($con));
		  }

		  	  if($titl2e>=2){
		      
		  mysqli_query($con,"INSERT INTO hole(code,plants,hole) VALUES('$age','0','2')")or die(mysqli_error($con));
		  }
		  	  if($titl2e>=3){
		      
		  mysqli_query($con,"INSERT INTO hole(code,plants,hole) VALUES('$age','0','3')")or die(mysqli_error($con));
		  }

	  	  if($titl2e>=4){
		      
		  mysqli_query($con,"INSERT INTO hole(code,plants,hole) VALUES('$age','0','4')")or die(mysqli_error($con));
		  }
  	  if($titl2e>=5){
		      
		  mysqli_query($con,"INSERT INTO hole(code,plants,hole) VALUES('$age','0','5')")or die(mysqli_error($con));
		  }
  	  if($titl2e>=6){
		      
		  mysqli_query($con,"INSERT INTO hole(code,plants,hole) VALUES('$age','0','6')")or die(mysqli_error($con));
		  }
...
?>  
              ...
              <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h5>Create Chamber</h5>
                    <p class="card-description"> Please provide the following information</p>
                    <form class="forms-sample" method="POST">
                      <div class="form-group">
                        <label for="exampleInputUsername1">Chamber Title</label>
                        <input type="text" class="form-control" name="title" required>
                      </div>
               
                      <div class="form-group">
                        <label for="exampleInputUsername1">Chamber Hole(s)</label>
                        <input type="number" max="6" min="1"class="form-control" name="hole" required>
                      </div>
